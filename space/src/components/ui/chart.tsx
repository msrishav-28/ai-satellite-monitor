...
/*
  Shared chart primitives adapted from the local shadcn-style layer.
  Updated in Phase 4 to align with Recharts v3 type exports so charts remain
  type-safe during production builds.
*/
